...
?>
    ...
    while ($fila=mysqli_fetch_array($resultados)) {///estamos creando un arrays para que nos lea todos los datos de bbdd.
       ...
       echo "<form action='../controllers/actualizar2.php' method='get' align='center'> ";

      echo "<h3>Actualizar Dispositivo</h3><br>";

       echo "<label  for='nombre'  class='lbcorrelativo'>Dispositivo</label><br>";
       echo" <input type='number_format(number)' class='dispositivoid'  name='id' readonly = 'readonly' value='" . $fila['dispositivoid'] . "'><br><br>";

        echo "<label for='nombre'  class='estadorec'>REC</label><br>";
        echo "<select style='width:180px;' name='estadorec'>
        ...
        echo "<select style='width:180px;' name='estadopc'>
        ...
        echo "<select style='width:180px;' name='estadoscratch'>
          ...
          <option value='Si'>Si</option>
           ...
           echo "<label for='nombre'  class='estadomovilidad'>Sin/Mov</label><br>";
        echo "<select style='width:180px;' name='estadomovilidad'>
          ...
          <option value='Si'>Si</option>
           ...
           echo "<label for='nombre'  class='estadoenfoque'>Mal/Enf</label><br>";
        echo "<select style='width:180px;' name='estadoenfoque'>
          ...
          <option value='Si'>Si</option>
           ...
           echo "<label for='nombre'  class='estadovision'>Vis/Obs/O</label><br>";
        echo "<select style='width:180px;' name='estadovision'>
