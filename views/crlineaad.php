...
<head>
  ...
  <title>Dispositivos Totales En Linea Copan Ruinas</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos En Linea en Copan Ruinas</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='EnLinea' and ciudadnombre='Copan Ruinas' order by dispositivositio";
  ...
  <table  class="table table-hover table-bordered">
    ...
    <script > 
      function open_new_window(){
        window.open('../pdf/lineacr.php', '_blank');
        return false;
      }
    </script>
    <thead>
