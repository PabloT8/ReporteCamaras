...
<div class="content-wrapper">
  ...
  <body>
    ...
    <center><h1>Busqueda de Dispositivos</h1></center>
    <br>
   <?php
...
include("../controllers/conexion.php");
  $conexion = conexion();
     ...
     $consulta = "SELECT * FROM dispositivo,ciudad where dispositivositio like '%$busqueda%' AND ciudadid=ciudadfk order by dispositivositio";
