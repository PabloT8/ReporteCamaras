...
<?php 
    ...
    $conexion=conexion();
     ...
     $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk order by dispositivositio";
...
<tr style="text-align:center">
    ...
    <td><?php $iplist=[$row['dispositivoip']];
              ...
              $sql1="UPDATE dispositivo,ciudad set dispositivoping ='$estado' where ciudadid=ciudadfk and dispositivoip='$ip'";
