...
<head>
  ...
  <title>Dispositivos Totales Fuera de Linea</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos Fuera de Linea</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT ciudadnombre,dispositivoip,dispositivositio,dispositivoid,dispositivodireccion,dispositivoping FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='FueraLinea' order by dispositivositio";
  ...
  <table class="table table-hover table-bordered">
    ...
    <script > 
      function open_new_window(){
        window.open('../pdf/fueralinea.php', '_blank');
        return false;
      }
    </script>
