...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <?php
    include ("../controllers/consultaverreportes.php");
    ?>
...
<div class="content-wrapper">
  ...
  <body>
    ...
    <center><h1>Reportes de Camaras</h1></center>
<br>
       <form name="form1" id="form1" action="reportebusqueda.php" method="get">
...
<script > 
    ...
    foreach ($resultado as $row) { ?>
      <tr>
        ...
        <td><?php echo $row['reporteestado'] ?></td>
        <td><?php echo "<a href='verestado.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-info'>Ver</button></a></td>"?></td>
        <td><?php echo "<a href='../pdf/reporteverestado.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-info'>PDF</button></a></td>"?></td>         
      </tr>
      <?php
    }  
    ?>
