...
<head>
  ...
  <title>Dispositivos Totales Fuera de Linea La Entrada Copan</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos Fuera Linea en La Entrada Copan</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='FueraLinea' and ciudadnombre='La Entrada' order by dispositivositio";
   ...
   <button  class="btn btn-primary float-right" onclick ="return open_new_window()" >Generar Reporte</button>
    ...
    <script > 
      function open_new_window(){
        window.open('../pdf/fueralec.php', '_blank');
        return false;
      }
    </script>
    <thead>
