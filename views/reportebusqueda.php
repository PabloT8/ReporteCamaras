...
include("../controllers/conexion.php");
  $conexion = conexion();
     ...
     $consulta = "SELECT * FROM reporte where reportefecha like '%$busqueda%' order by reporteid DESC";
   ...
   <table class="table table-hover table-bordered" >
    ...
    foreach ($resultado as $row) { ?>
      <tr>
        ...
        <td><?php echo "<a href='verestado.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-info'>Ver</button></a></td>"?> 
        <td><?php echo "<a href='../pdf/reporteverestado.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-info'>PDF</button></a></td>"?>
      </tr>
      <?php
    }  
    ?>
