...
<head>
    ...
    <title>Ping de Camaras de La Entrada Copan</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                        <center><h1>Ping de Camaras de La Entrada Copan</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and ciudadnombre='La Entrada' order by dispositivositio";
...
<tr style="text-align:center">
    ...
    <td><?php $iplist=[$row['dispositivoip']];
             ...
             $sql1="UPDATE dispositivo,ciudad set dispositivoping ='$estado' where ciudadid=ciudadfk and ciudadnombre='La Entrada' and dispositivoip='$ip'";
