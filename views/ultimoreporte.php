...
<div class="content-wrapper">
  ...
  <body>
    ...
    <center><h1>Reporte de Camaras Anterior</h1></center>
    <br>
  <?php
...
$username=$_SESSION['username'];
     ...
     $consulta = "SELECT * FROM reporte order by reporteid desc limit 2";
   ...
   <table class="table table-hover table-bordered" >
    ...
    foreach ($resultado as $row) { ?>
      <tr>
        ...
        <td><?php echo "<a href='ultimoreportever.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-primary'>Ver</button></a></td>"?>         
      </tr>
      <?php
    }  
    ?>
