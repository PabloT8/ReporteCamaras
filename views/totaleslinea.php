...
<head>
  ...
  <title>Dispositivos Totales En Linea</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos en Linea</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT ciudadnombre,dispositivoip,dispositivositio,dispositivoid,dispositivodireccion,dispositivoping FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='EnLinea' order by dispositivositio";
...
<script > 
      function open_new_window(){
        window.open('../pdf/linea.php', '_blank');
        return false;
      }
    </script>
