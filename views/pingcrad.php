...
<head>
    ...
    <title>Ping de Camaras de Copan Ruinas</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                        <center><h1>Ping de Camaras de Copan Ruinas</h1></center>
    <table>
<?php 
    ...
    $conexion=conexion();
     ...
     $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and ciudadnombre='Copan Ruinas' order by dispositivositio";
...
<tr style="text-align:center">
    ...
    <td><?php $iplist=[$row['dispositivoip']];
              ...
              $sql1="UPDATE dispositivo,ciudad set dispositivoping ='$estado' where ciudadid=ciudadfk and ciudadnombre='Copan Ruinas' and dispositivoip='$ip'";
