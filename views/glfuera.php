...
<head>
  ...
  <title>Dispositivos Totales Fuera Linea Gracias Lempira</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos Fuera Linea en Gracias Lempira</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='FueraLinea' and ciudadnombre='Gracias' order by dispositivositio";
   ...
   <button  class="btn btn-primary float-right" onclick ="return open_new_window()" >Generar Reporte</button>
    ...
    <script > 
      function open_new_window(){
        window.open('../pdf/fueragl.php', '_blank');
        return false;
      }
    </script>
    <thead>
