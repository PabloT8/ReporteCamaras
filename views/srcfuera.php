...
<head>
  ...
  <title>Dispositivos Totales Fuera Linea Santa Rosa de Copan</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos Fuera Linea en Santa Rosa de Copan</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='FueraLinea' and ciudadnombre='Santa Rosa de Copan' order by dispositivositio";
  ...
  <table class="table table-hover table-bordered">
    ...
    <script > 
      function open_new_window(){
        window.open('../pdf/fueralineasrc.php', '_blank');
        return false;
      }
    </script>
    <thead>
