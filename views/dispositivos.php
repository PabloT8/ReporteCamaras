...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <?php
    include ("../controllers/consultadispositivos.php");
    ?>
...
<div class="content-wrapper">
  ...
  <body>
    ...
    <center><h1>Todos los Dispositivos Actuales</h1></center>
<br>
<button onclick="location.href='agregardisp.php'" style="width:300px; float: right;" type="submit" name="agregardisp" class="btn btn-primary btn-block"><span class="fas fa-plus-circle"></span> Agregar Nuevo Dispositivo</button><br><br>
       <form name="form1" id="form1" action="dispositivobusqueda.php" method="get">
        
        <div class="input-group">
           <input type="text" name="buscar" class="form-control">
           <span class="input-group-btn">
         <button style="width:130px;" type="submit" name="enviar" class="btn btn-primary btn-block"><span class="fas fa-search"></span> Buscar</button>
...
<script > 
    ...
    foreach ($resultado as $row) { ?>
      <tr style="text-align:center">
        ...
        <td><?php echo $row['dispositivotipo'] ?></td>
        <td><?php echo $row['dispositivoip'] ?></td>
        <td><?php echo $row['ciudadnombre'] ?></td>
        <td><?php echo "<a href='actualizardisp.php?dispositivoid=".$row['dispositivoid']."''><button type='button' class = 'btn btn-warning fas fa-edit'></button></a></td>"?></td>
        <td><?php echo "<a href='../controllers/eliminardisp.php?dispositivoid=".$row['dispositivoid']."''><button type='button' class = 'btn btn-danger fas fa-trash-alt'></button></a></td>"?></td>         
      </tr>
      <?php
    }  
    ?>
