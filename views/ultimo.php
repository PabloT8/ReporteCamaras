...
<div class="content-wrapper">
  ...
  <body>
    ...
    <center><h1>Reporte de Camaras</h1></center>
    <br>
  <?php
...
$username=$_SESSION['username'];
     ...
     $consulta = "SELECT * FROM reporte where reporteestado='Sin Finalizar' and reporteusuario like '%$username%' order by reporteid desc limit 1";
   ...
   <table class="table table-hover table-bordered" >
    ...
    foreach ($resultado as $row) { ?>
      <tr>
        ...
        <td><?php echo "<a href='ultimocontinuar.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-primary'>Agregar</button></a></td>"?> 
        <td><?php echo "<a href='../pdf/reporteverestado.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-primary'>PDF</button></a></td>"?></td>        
      </tr>
      <?php
    }  
    ?>
