...
<div class="content-wrapper">
  ...
  <body>
    ...
    <center><h1>Dispositivos con problemas de REC en Santa Rosa de Copan</h1></center>
    <br>
  <?php
   ...
   <table class="table table-hover table-bordered" >
    ...
    foreach ($resultado as $row) { ?>
      <tr>
        ...
        <td><?php echo "<a href='../pdf/recsrc.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-info'>Continuar</button></a></td>"?>         
      </tr>
      <?php
    }  
    ?>
