...
<head>
  ...
  <title>Dispositivos Totales En Linea Santa Rosa de Copan</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos En Linea en Santa Rosa de Copan</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='EnLinea' and ciudadnombre='Santa Rosa de Copan' order by dispositivositio";
...
?>
    ...
    <script > 
      function open_new_window(){
        window.open('../pdf/lineasrc.php', '_blank');
        return false;
      }
    </script>
    <thead>
