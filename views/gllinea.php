...
<head>
  ...
  <title>Dispositivos Totales En Linea Gracias Lempira</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="verreportes.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="masreportes.php" class="nav-link">
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                         <center><h1>Total de Dispositivos En Linea en Gracias Lempira</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='EnLinea' and ciudadnombre='Gracias' order by dispositivositio";
   ...
   <button  class="btn btn-primary float-right" onclick ="return open_new_window()" >Generar Reporte</button>
    ...
    <script > 
      function open_new_window(){
        window.open('../pdf/lineagl.php', '_blank');
        return false;
      }
    </script>
    <thead>
