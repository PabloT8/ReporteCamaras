...
<?php 
    ...
    $sql="SELECT ciudadnombre,dispositivoip,dispositivositio,dispositivoid,dispositivoping FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='FueraLinea' and ciudadnombre='Copan Ruinas' order by dispositivositio";
