...
<body>
  ...
  <form name="form1" id="form1" method="GET" action="../controllers/actualizarreporte.php">
    ...
    echo $_GET["reporteid"]?>" required></input> 

    <input  type="submit" value="Finalizado" class="btn btn-primary" >
 
  </form>
  <br>
  <form name="form1" id="form1" method="POST" action="../controllers/agregarcontinuar.php">
    <input type="hidden" name="reporteid" id="reporteid"  value="<?php echo "" . $_GET["reporteid"] . "";?>">
...
<br>
  ...
  foreach ($resultado as $row) { ?>
    <tr>
      ...
      <td><?php echo "<a href='actualizardispositivo2.php?estadoid=".$row['estadoid']."''><button type='button' class = 'btn btn-warning fas fa-edit'></button></a></td>"?> 
      <td><?php echo "<a href='../controllers/eliminar2.php?estadoid=".$row['estadoid']."''><button type='button' class = 'btn btn-danger fas fa-trash-alt'></button></a></td>"?>
    </tr>
    <?php
  }  
  ?>
