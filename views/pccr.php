...
<div class="content-wrapper">
  ...
  <body>
   ...
   <center><h1>Dispositivos con problemas de PC en Copan Ruinas</h1></center>
   ...
   <table class="table table-hover table-bordered" >
    ...
    foreach ($resultado as $row) { ?>
      <tr>
        ...
        <td><?php echo "<a href='../pdf/pccr.php?reporteid=".$row['reporteid']."''><button type='button' class = 'btn btn-info'>Continuar</button></a></td>"?>         
      </tr>
      <?php
    }  
    ?>
