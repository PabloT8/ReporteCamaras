...
<head>
    ...
    <title>Ping de Camaras de Santa Rosa de Copan</title>
    ...
    <!-- /.sidebar -->
      ...
      <div class="content-header">
        ...
        <div class="container-fluid">
                   ...
                   <div>
                     <body>
                        <center><h1>Ping de Camaras de Santa Rosa de Copan</h1></center>
    <table>
<?php 
    ...
    $sql="SELECT * FROM dispositivo,ciudad where ciudadid=ciudadfk and ciudadnombre='Santa Rosa de Copan' order by dispositivositio";
...
<tr style="text-align:center">
    ...
    <td><?php $iplist=[$row['dispositivoip']];
             ...
             $sql1="UPDATE dispositivo,ciudad set dispositivoping ='$estado' where ciudadid=ciudadfk and ciudadnombre='Santa Rosa de Copan' and dispositivoip='$ip'";
