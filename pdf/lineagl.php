...
$sql="SELECT ciudadnombre,dispositivoip,dispositivositio,dispositivoid,dispositivodireccion,dispositivoping FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='EnLinea' and ciudadnombre='Gracias' order by dispositivositio";
