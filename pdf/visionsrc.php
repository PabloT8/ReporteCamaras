...
// Cabecera de página
    ...
    // Salto de línea
        ...
        $this->Cell(58,10,'Vision Obstruida',1,0,'C',0);
...
$sql="SELECT * FROM estado,dispositivo,ciudad,reporte where ciudadid=ciudadfk and dispositivoid=dispositivofk and reporteid=reportefk and reporteid='$ACT' and ciudadnombre='Santa Rosa de Copan' and estadovision='Si' order by dispositivositio";
...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(58,10,utf8_decode($row['estadovision']),1,0,'C',0);
