...
$sql="SELECT * FROM estado,dispositivo,ciudad,reporte where ciudadid=ciudadfk and dispositivoid=dispositivofk and reporteid=reportefk and reporteid='$ACT' and ciudadnombre='La Entrada' and estadoscratch='Si' order by dispositivositio";
