...
function Header()
{
    ...
    $this->Cell(95);
    // Título
    $this->Cell(50,50,'Reporte Dispositivos Fuera de Linea',0,0,'C');
    // Salto de línea
    $this->Ln(35);
...
$sql="SELECT ciudadnombre,dispositivoip,dispositivositio,dispositivoid,dispositivodireccion,dispositivoping FROM dispositivo,ciudad where ciudadid=ciudadfk and dispositivoping='FueraLinea' and ciudadnombre='Santa Rosa de Copan' order by dispositivositio";
