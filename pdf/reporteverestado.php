...
$resultado10=$conexion->query($sql10);
    ...
    $this->Cell(1,95,"Tecnico: ".$row['reporteusuario'],0,0,'C');
}
    // Salto de línea
    $this->Ln(50);
...
//----------------------------------------------------------------------------------------------
$sql7="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='EnLinea' and ciudadnombre='Santa Rosa de Copan' and ciudadid=ciudadfk";
$resultado7=$conexion->query($sql7);
 
$sql8="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='FueraLinea' and ciudadnombre='Santa Rosa de Copan' and ciudadid=ciudadfk";
$resultado8=$conexion->query($sql8);

$sql11="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='EnLinea' and ciudadnombre='Gracias' and ciudadid=ciudadfk";
$resultado11=$conexion->query($sql11);
 
$sql12="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='FueraLinea' and ciudadnombre='Gracias' and ciudadid=ciudadfk";
$resultado12=$conexion->query($sql12);

$sql13="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='EnLinea' and ciudadnombre='Copan Ruinas' and ciudadid=ciudadfk";
$resultado13=$conexion->query($sql13);
 
$sql14="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='FueraLinea' and ciudadnombre='Copan Ruinas' and ciudadid=ciudadfk";
$resultado14=$conexion->query($sql14);

$sql15="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='EnLinea' and ciudadnombre='La Entrada' and ciudadid=ciudadfk";
$resultado15=$conexion->query($sql15);
 
$sql16="SELECT count(dispositivoping) as Total from dispositivo,ciudad where dispositivoping='FueraLinea' and ciudadnombre='La Entrada' and ciudadid=ciudadfk";
...
//--------------------------------------------Resultados---------------------------------------------
    ...
    $pdf->Cell(8,50," ".$row['Total']." en Gracias Lempira,",0,0,'C',0);
    }
    
     while ($row = $resultado11->fetch_assoc()) {
    $pdf->Cell(137,50,utf8_decode("de las cuales ".$row['Total']." se encuentran en linea y"),0,1,'C',0);
    }
    ...
    $pdf->Cell(144,-30,utf8_decode("de las cuales ".$row['Total']." se encuentran en linea y"),0,0,'C',0);
    }
    
    while ($row = $resultado14->fetch_assoc()) {
    $pdf->Cell(22,-30,utf8_decode("".$row['Total']." se encuentran fuera de linea, "),0,0,'C',0);
    }
